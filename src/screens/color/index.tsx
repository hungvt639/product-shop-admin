...
const ColorComponent = () => {
  const { colors, del, showEdit, setShowEdit, itemEdit, setItemEdit, edit, showCreate, setShowCreate, create } =
    useColor();
  ...
  const colums = [
    ...
    },
    {
      ...
      dataIndex: "code",
      key: "code-show",
      render: (text: string) => <div style={{ backgroundColor: text }} className="show-color"></div>,
    },
    {
      title: "Mã màu",
      dataIndex: "code",
  ...
  return (
    <div className="_color p-5 overflow-auto h-full">
      ...
      <Table pagination={false} columns={colums} dataSource={colors} rowKey={(r) => r._id} />

...
const ProductComponent = () => {
  const { docs, products, fHandler, del, itemEdit, setItemEdit, showModel, setShowModel, pages, setPages } =
    useProduct();
  const colums = [
    {
      title: "STT",
    ...
    },
    {
      ...
      dataIndex: "img",
      key: "img",
      render: (text: string) => <Image height={100} width={100} src={text} />,
    },
    {
      title: "Nhóm",
      dataIndex: "type",
    ...
    },
    {
      ...
      render: (text: boolean, record: Product) => (
        <Switch defaultChecked={text} onChange={() => fHandler({ isSale: !record.isSale }, record._id)} />
      ),
    },
    {
      title: "Action",
  ...
  return (
    <div className="_product p-5 overflow-auto h-full">
      ...
      <Table pagination={false} columns={colums} dataSource={products} rowKey={(r) => r._id} />
